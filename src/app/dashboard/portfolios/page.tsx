  ...
  const fetchPortfolios = async () => {
    try {
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: error.message || "Failed to fetch portfolios",
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold">Portfolios List</h2>
          ...
          <TableBody>
            {portfolios.map((portfolio) => (
              <TableRow key={portfolio._id}>
                ...
                <TableCell>{portfolio.name_uz}</TableCell>
                <TableCell>{portfolio.name_ru}</TableCell>
